...
This is not yet implemented, so the current approach is a bit less pretty:
...
To get information on a moderator not included above would just require rerunning the final line:
