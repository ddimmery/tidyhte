...
`tidyhte` provides tidy semantics for estimation of heterogeneous treatment effects through the use of [Kennedy's (n.d.) doubly-robust learner](https://arxiv.org/abs/2004.14497).
...
You will be able to install the released version of tidyhte from [CRAN](https://CRAN.R-project.org) with:

``` r
install.packages("tidyhte")
```

But this does not yet exist. In the meantime, install the development version from [GitHub](https://github.com/) with:
...
Support for the package will also be provided in the Experimentation Community Discord: [![](https://dcbadge.vercel.app/api/server/MrxjbHc3jD?theme=clean&compact=true)](https://discord.com/invite/MrxjbHc3jD)
